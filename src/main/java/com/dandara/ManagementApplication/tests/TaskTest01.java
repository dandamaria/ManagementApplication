...
public class TaskTest01 {
    public static void main(String[] args) {
        Task tarefa_teste = new Task(98, "criar um novo layout", Duration.ofHours(1), false);
        Task tarefa_teste2 = new Task(98, "separar os pngs", Duration.ofMinutes(20), false);
        Task tarefa_teste3 = new Task(98, "salvar o arquivo em pdf", Duration.ofSeconds(20), true);
        Task tarefa_teste4 = new Task(98, "participar do evento", Duration.ofDays(1), false);
